...
<div class="nav-container">
	...
	<div class="nav">
		...
		<div class="nav-left">
			<ul>
				<li><img src="assets/images/Screenshot_8.png" alt="" height="50px" width="50px" margin-top="1px"></li>
				<li><a href="javascript: void(0);"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
				<li><a href="i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Notifications<span id ="notification"><?php if ($notify->totalN > 0) {
						 ...
						 <div class="tweet-footer">
						 	<div class="t-fo-left">
						 		<ul>
						 			...
						 			<span class="tweet-error"><?php if(isset($error)){echo $error;} else if(isset($imageError)){
