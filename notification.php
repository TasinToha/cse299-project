<?php 
	...
	if(isset($_POST['tweet'])){
		...
		if (!empty($status) or !empty($_FILES['file']['name'])){
			...
			$getFromU->create('tweets',array('status' => $status, 'tweetBy' => $user_id,'tweetImage' => $tweetImage));
	...
	<div class="nav">
		...
		<div class="nav-right">
			<ul>
				...
				<li><label class="Post">Post</label></li>
			</ul>
		</div><!-- nav right ends-->
...
<div class="notification-wrapper">
	<div class="notification-inner">
		<div class="notification-header">
			...
			<a href="<?php  echo 'http://localhost/Connectify/'.$data->profileImage;?>" class="notifi-name"><?php  echo $data->screenName;?></a><span> Followed you <span></span>
